defmodule MyApp.AccountTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", is_active: true, password: "123"}
    @update_attrs %{email: "some updated email", is_active: false, password: "1234"}
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert Bcrypt.verify_pass("123", user.password_hash)
    end
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert Bcrypt.verify_pass("1234", user.password_hash)
    end
